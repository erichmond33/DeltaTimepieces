...
urlpatterns = [
    ...
    path("sell_and_trade/", sell_and_trade_view, name="sell_and_trade"),
    path("consignment/", consignment_view, name="consignment"),
    path("evaluations/<str:form_name>/", evaluations_view, name="evaluations"),
